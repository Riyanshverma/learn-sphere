        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div className="space-y-2 font-sans">
              ...
              {errors.aadhar_card_photo && <p className="text-sm text-destructive">{errors.aadhar_card_photo.message as string}</p>}
            </div>
            ...
            <div className="space-y-2 font-sans">
              ...
              {errors.pan_card_photo && <p className="text-sm text-destructive">{errors.pan_card_photo.message as string}</p>}
            </div>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-4">
            ...
            <div className="space-y-2 font-sans">
              ...
              />
              {errors.bank_account_type && <p className="text-sm text-destructive">{errors.bank_account_type.message}</p>}
            </div>
