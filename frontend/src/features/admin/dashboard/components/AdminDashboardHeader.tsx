...
export const AdminDashboardHeader = ({ activeTab, setActiveTab, onAddSchoolStaffPage = false, onClassDetailsPage = false }: HeaderProps) => {
  ...
  const handleTabClick = (key: string) => {
    if (onAddSchoolStaffPage || onClassDetailsPage) {
