    ...
    <header className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4">
      <div className="flex items-center justify-between px-6 py-3 bg-background/40 backdrop-blur-md border border-foreground/60 rounded-full w-full max-w-7xl pointer-events-auto">
                ...
                <NavigationMenuItem key={item.id}>
                  <NavigationMenuLink
                    ...
                    className={cn(
                      ...
                      "text-base font-normal rounded-full cursor-pointer px-6 h-8 font-sans",
        ...
        <div className="flex flex-1 items-center justify-end gap-4">
          <Button
            variant="outline"
            className="font-sans text-base font-normal flex items-center gap-2 rounded-full px-6 py-4 hover:bg-card/80"
          ...
          <Button 
            variant="destructive"
            className="font-sans text-base font-normal flex items-center gap-2 rounded-full px-6 py-4"
