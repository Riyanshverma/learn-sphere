      ...
      <DialogContent className="dark sm:max-w-3xl bg-background backdrop-blur-xl rounded-3xl overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="font-sans text-muted-foreground font-light text-base">
            Initiate payout via RazorpayX to the employee's linked bank account.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6 font-sans font-light text-base">
          <section className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <DialogDetailItem label="Leaves Taken" value={`${employeepayrollDetails.leaves.leaves_taken} day(s)`} className="col-span-2"/>
              <DialogDetailItem label="Account Number" value={employeepayrollDetails.bank_details.account_number} className="col-span-2" />
              <DialogDetailItem label="Account Name" value={<span className="capitalize">{employeepayrollDetails.bank_details.account_holder_name}</span>} className="col-span-2"/>
              <DialogDetailItem label="IFSC Code" value={employeepayrollDetails.bank_details.ifsc_code} className="col-span-2"/>
              <DialogDetailItem label="Bank & Branch" value={<span className="capitalize">{employeepayrollDetails.bank_details.bank_name} ({employeepayrollDetails.bank_details.branch_name})</span>} className="col-span-2" />
            </div>
          </section>
