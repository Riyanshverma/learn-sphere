...
import { fetchEmployeesAttendance, changeEmployeeAttendance, applyForLeaveApplication } from "./admin/quick-actions.controller";
export { fetchEmployeesAttendance, changeEmployeeAttendance, applyForLeaveApplication }
