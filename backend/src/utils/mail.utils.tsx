...
export const InvitationMailTemplate = ({ url }: { url: string }): React.JSX.Element => {
  return (
    <div style={{ backgroundColor: "#0a0a0a", color: "#ffffff", fontFamily: "'Inter', -apple-system, sans-serif", margin: 0, padding: 0}}>
      <div style={{ maxWidth: "600px", margin: "40px auto", padding: "40px", backgroundColor: "#121212", border: "1px solid rgba(255, 255, 255, 0.1)", borderRadius: "24px", textAlign: "center" }}>
        ...
        <h1 style={{ fontSize: "28px", fontWeight: 200, marginBottom: "16px", color: "#ffffff" }}>Invitation</h1>

        <p style={{ fontSize: "16px", fontWeight: 200, lineHeight: "1.6", color: "#a1a1aa", marginBottom: "32px" }}>
          You have been invited to join Learn Sphere. Since you already have an account on our platform, you can simply click the button below to link your existing account and complete your teacher profile.
        </p>

        <div style={{ marginBottom: "32px" }}>
          <a href={url} style={{ display: "inline-block", padding: "16px 36px", backgroundColor: "#008235", color: "#ffffff", textDecoration: "none", fontSize: "16px", fontWeight: 500, borderRadius: "12px" }}>Accept Invitation</a>
        </div>
